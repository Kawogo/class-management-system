$(document).ready(function(){
    ...
    $("#products-datatable").DataTable(
    {
        language:
        {
            ...
            info:"Showing data _START_ to _END_ of _TOTAL_",
        ...
        //         {
        //             // orderable:!1,
        //             // render:function(e,l,a,o){return"display"===l&&(e='<div class="form-check"><input type="checkbox" class="form-check-input dt-checkboxes"><label class="form-check-label">&nbsp;</label></div>'),
        //             // e},
        //             checkboxes:{
        //             selectRow:!0,
