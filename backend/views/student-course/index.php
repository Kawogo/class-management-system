        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Student/Course</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col">
                            <div class="col-sm-4">                     
                                <a href="<?=  Url::to(['/student-course/create']) ?>" class="btn btn-sm btn-primary mb-2"><i class="mdi mdi-plus-circle-outline me-1"></i> Assign new student</a>
                            </div>
                            </div><!-- end col-->
                        </div>
