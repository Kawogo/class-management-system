...
class User extends ActiveRecord implements IdentityInterface
{
     ...
     */
    public function setPassword($password,$password_verify)
    {
        $this->password_hash = Yii::$app->security->generatePasswordHash($password);
        $this->password_verify = Yii::$app->security->generatePasswordHash($password_verify);
    }
    ...
    {
        $this->password_hash = Yii::$app->security->generatePasswordHash($default_password);
